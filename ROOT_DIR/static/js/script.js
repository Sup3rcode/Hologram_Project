            ...
            pageTransition({
                ...
                conditions: function(event, link) {
                    return link &&
                        ...
                        !event.currentTarget.classList.contains('jp-playlist-item') &&
        ...
        var lineChart,
            lineChartObject = {
                ...
                data: {
                    x: 'x',
                    columns: [
                        ['x', '2022-03-01', '2022-04-01', '2022-05-01', '2022-06-01', '2022-07-01', '2022-08-01', '2022-09-01', '2022-10-01', '2022-11-01'],
            ...
            for (var i = 0; i < plugins.swiper.length; i++) {
                ...
                var
                    ...
                    options = {
                        ...
                        speed: sliderMarkup.getAttribute('data-speed') ? Number(sliderMarkup.getAttribute('data-speed')) : 2000,
                ...
                if (sliderMarkup.getAttribute('data-autoplay')) {
                    options.autoplay = {
                        delay: Number(sliderMarkup.getAttribute('data-autoplay')) || 5000,
